...
!	parameter (z_entr = 258.0 + 0.0) ! from target center to Q1 mechanical entrance (from M. Fowler's drawing)
	...
	real*8 dxdzs_fp,dydzs_fp,xs_fp,ys_fp
...
c 2011        parameter(zd_q1men = 28.05)
        parameter(zd_q1men = 28.35) ! 2017
c 2011        parameter(zd_q1mid = 93.95)
        parameter(zd_q1mid = 93.65) ! 2017
c 2011        parameter(zd_q1mex = 93.95)
        parameter(zd_q1mex = 93.65) !2017
c 2011        parameter(zd_q1out = 28.05)
        parameter(zd_q1out = 28.35) !2017
        parameter(zd_q2in  = 25.55)
c        parameter(zd_q2men = 36.45)
        parameter(zd_q2men = 39.10) !2107
c        parameter(zd_q2mid = 82.00)
        parameter(zd_q2mid = 79.35)
c        parameter(zd_q2mex = 81.99)
        parameter(zd_q2mex = 79.35)
c        parameter(zd_q2out = 36.45)
        parameter(zd_q2out = 39.10)
        parameter(zd_q3in  = 28.10)
c        parameter(zd_q3men = 36.45)
        parameter(zd_q3men = 39.10)
c        parameter(zd_q3mid = 82.00)
        parameter(zd_q3mid = 79.35) !
c        parameter(zd_q3mex = 81.99)
        parameter(zd_q3mex = 79.35)
c        parameter(zd_q3out = 36.45)
        parameter(zd_q3out = 39.10)
        parameter(zd_q3d1trans  = 18.00)
        parameter(zd_d1flare = 30.10)
c        parameter(zd_d1men = 39.50)
        parameter(zd_d1men = 39.47)
        parameter(zd_d1mid1= 36.406)
        parameter(zd_d1mid2= 36.406)
        parameter(zd_d1mid3= 36.406)
        parameter(zd_d1mid4= 36.406)
        parameter(zd_d1mid5= 36.406)
        parameter(zd_d1mid6= 36.406)
        parameter(zd_d1mid7= 36.406)
        parameter(zd_d1mex = 36.406)
