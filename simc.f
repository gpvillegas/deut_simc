...
!	ok flag
     ...
     >		y_P_arm, z_P_arm, dx_P_arm, dy_P_arm, xfp, dxfp, yfp, dyfp,
     >		m2, mc_smear, mc_smear, doing_decay,
     >		ntup%resfac, x_P_arm, ok_P_arm, pathlen, col_flag)
...
! Fill recon quantities.
	...
	call physics_angles(spec%p%theta + spec%p%shift%theta,
     >                      spec%p%phi + spec%p%shift%phi ,
     >                      dx_tmp,
...
!	ok flag
     ...
     >		y_E_arm, z_E_arm, dx_E_arm, dy_E_arm, xfp, dxfp, yfp, dyfp,
     >		me2, mc_smear, mc_smear, .false.,
     >		tmpfact, x_E_arm, ok_E_arm, pathlen, col_flag)
...
! Fill recon quantities%
	...
	call physics_angles(spec%e%theta + spec%e%shift%theta,
     >   	spec%e%phi + spec%e%shift%phi,
     >          dx_tmp,
